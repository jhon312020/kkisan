      ...
      <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-header">{{ __('Setting Update') }} <a href="{{ url('/settingHome') }}" style="position: absolute;right: 10px;" class="btn btn-primary btn-sm"><i class="fas fa-gear"></i> Setting</a></div>
